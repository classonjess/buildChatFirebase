(function () {
  ...
  const firebaseConfig = {
    apiKey: "AIzaSyArBr1YxN9ZKhXnLVKaexlWNrJn5pqpxws",
    authDomain: "chatappfirebase-f1a5c.firebaseapp.com",
    projectId: "chatappfirebase-f1a5c",
    storageBucket: "chatappfirebase-f1a5c.appspot.com",
    messagingSenderId: "699246263155",
    appId: "1:699246263155:web:75411af304917a8686a306"
  };
  // Initialize Firebase
  ...
  let currentUserEmail = ('sender'); // variable to store the current user's email
 ...
 function updateCurrentUser(userEmail) {
  ...
  signup.addEventListener('click', (e) => {
    ...
    promise.then((resp) => {
      console.log("User signed up", userNameDisplay);
      logout.style.display = 'inline';
      login.style.display = 'none';
      signup.style.display = 'none';
      write.style.display = 'inline';
      updateCurrentUser(userNameDisplay);
    });
    promise.catch((e) => console.log(e.message));
  });
